...
-- =========================================================================
-- Public-read bucket where each user can only write objects under their own
-- user id prefix ("<uid>/..."). The avatar_url column on profiles points
-- to a public URL in this bucket.
insert into storage.buckets (id, name, public)
values ('avatars', 'avatars', true)
on conflict (id) do update set public = excluded.public;

-- RLS policies. Storage policies live on storage.objects.
